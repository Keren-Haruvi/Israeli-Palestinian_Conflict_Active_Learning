...
class ActiveLearningPipeline:
    ...
    def _find_optimal_clusters(self, data, min_clusters=3, max_clusters=15):
        """
        find the optimal number of clusters for the given data using the silhouette score
        """
...
if __name__ == "__main__":
    ...
    if plot_comparison:
        ...
        augmentation_accuracy_dict['adaptive weight & custom clusters'] = best_dict[features[0]][models[0]]['adapted']
